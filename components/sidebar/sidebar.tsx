...
import { IState, setShowDeskTopSidebar, setShowProfileInfo, setShowSideBar } from "../../redux/sclice/clientSclice";
...
export default function Sidebar() {
    // redux hooks
    const showFullDeskTopSidebar = useSelector((state: IState) => state.uiSclice.showDeskTopSidebar);
    const showSideBar = useSelector((state: IState) => state.uiSclice.showSideBar);
    ...
    async function clieckToSignOut() {
        try {
            ...
            setLoading(false);
            toast.custom((t) => (
                <NoficationToast t={t} success={false} msg={`SignOut faild try again!`} />
            ))
        }
    };
    ...
    return (
        <>
            ...
            <div>
                {
                    showFullDeskTopSidebar ? <aside className=" hidden lg:flex duration-200 showFullDeskTopSidebar  flex-col w-64 h-screen px-5 py-8 pt-2 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
                        <div className="flex justify-between items-center">
                            {/* <span className="text-gray-400 uppercase font-semibold">Abir Santra</span> */}
                            <span className="font-bold font-signature text-2xl hidden mxs:block">Abir Santra</span>


                            <a className="bg-gray-800 px-3 py-2 flex justify-end rounded-md" onClick={() => dispatch(setShowDeskTopSidebar())}>
                                {/* <svg
                        ...
                        <div className="flex flex-col justify-between flex-1 mt-6">
                            <nav className="flex-1 -mx-3 space-y-3 ">
                                ...
                                {client && client.role === UserRole.ADMIN && <Link
                                    className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
                                    href="/users"
                                >
                            ...
                            <div className="mt-6">
                                ...
                                <div className="flex items-center justify-between mt-6">
                                    {client && (
                                        <Link href={`/profile/${client._id}`} className="flex items-center gap-x-2">
                                            <Image
                        ...
                        className=" duration-200 showFullDeskTopSidebar hidden lg:flex flex-col items-center w-16 h-screen py-8 pt-2 overflow-y-auto bg-white border-r dark:bg-gray-900 dark:border-gray-700">
                        <nav className="flex flex-col items-center flex-1 space-y-6">
                            <a className="bg-gray-800 px-2 py-2 rounded-md" onClick={() => dispatch(setShowDeskTopSidebar())}>
            ...
            {/*FOR MOBILE SIDEBAR*/}
            <aside
                className={`fixed flex z-60 flex-col  w-64 h-screen px-5 py-8 pt-4 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 ${showSideBar ? " duration-300" : " duration-300 -translate-x-[50rem]"}`}>

                <div className="flex flex-col justify-between flex-1 ">
                    <div className={`flex justify-between`}>
                        <span className="font-bold font-signature text-2xl">Abir Santra</span>
                        <VscChromeClose size={28} className={`bg-gray-700 p-2 rounded-sm mb-4`}
                        ...
                        <div className="p-3 bg-gray-100 rounded-lg dark:bg-gray-800">
                            ...
                            <Link href={`/blog`}>
                                <Image
                                    className="object-cover w-full h-32 mt-2 rounded-lg"
                                    src={`https://images.unsplash.com/photo-1605379399642-870262d3d051?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=1806&amp;q=80`}
                                    alt="Feature" width={80} height={60} />
                            </Link>
                        </div>
                        <div className="flex items-center justify-between mt-6">
                            {client && (
