                ...
                <div className="px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16 -mb-px">
                        ...
                        <div className="flex  gap-x-4 md:gap-x-8 justify-between items-center">
                            ...
                            <svg onClick={() => dispatch((setShowSideBar()))} xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-align-left cursor-pointer stroke-slate-400 hover:stroke-slate-200 lg:hidden" width="36" height="36" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#597e8d" fill="none" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <div
                                    className={`fixed inset-0 bg-slate-900 bg-opacity-30 z-50 transition-opacity ${showSearchBtn ? "duration-300" : " duration-300 -translate-y-[80rem]"}`}></div>
                                {/* Modal dialog  */}
                                <div
                                    id="search-modal"
                                    className={`fixed inset-0 z-50 overflow-hidden flex items-start top-20 mb-4 justify-center px-4 sm:px-6  ${showSearchBtn ? " duration-300 " : " duration-300 -translate-y-[80rem] "}`}
                                    role="dialog"
                                >
                            ...
                            <div className="relative inline-flex">
                                ...
                                {/*TODO*/}
                                <div
                                    className={`origin-top-right z-10 absolute top-12 right-0 -mr-48 sm:mr-0 xs:mr-0 min-w-80 vxs:-mr-32 bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1 ${showNotificationBtn ? " duration-300" : " duration-300 -translate-y-[80rem]"}`}>
                                    <div className=" flex justify-between">
                                        <div
                                            className="text-xs font-semibold text-slate-400 uppercase pt-1.5 pb-2 px-4 ">
                                            Notifications
                                        </div>
                                        <HiOutlineXCircle size={24} color="red" className=" mr-1"
                                            onClick={() => setShowNotificationBtn((prev) => !prev)} />
                                    </div>
                                    <ul>
                            ...
                            <div className="relative inline-flex ">
                                ...
                                < div
                                    className={`origin-top-right z-10 absolute top-12 right-0 min-w-44 bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1 ${showInfoBtn ? " duration-300" : " duration-300 -translate-y-[50rem]"}`}>
                                    <div className="flex justify-between">
                                        <div
                                            className="text-xs font-semibold text-slate-400 uppercase pt-1.5 pb-2 px-3 ">
                                            Need help ?
                                        </div>
                                        <HiOutlineXCircle size={24} color="red" className=" mr-1"
                                            onClick={() => setShowInfoBtn((prev) => !prev)} />
