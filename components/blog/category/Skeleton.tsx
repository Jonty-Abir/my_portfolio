function Skeleton() {
  return (
    <div className=" w-screen mt-4 flex flex-col lg:flex-row justify-center gap-4">
      <div
        role="status"
      ...
      <div
        role="status"
        className=" mt-4  max-w-sm p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-700 lg:mt-0 "
      >
        <div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-32 mb-2.5"></div>
        <div className="w-48 h-2 mb-10 bg-gray-200 rounded-full dark:bg-gray-700"></div>
        <div className="flex items-baseline mt-4 space-x-6">
