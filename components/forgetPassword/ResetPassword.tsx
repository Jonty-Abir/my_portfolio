    ...
    const formik = useFormik({
        ...
        onSubmit: async (value) => {
            try {
                ...
                setLoading(false);
                toast.custom((t) => <NoficationToast t={t} msg={"SUCCESS"} success={true} />)
                router.push("/signIn");
            } catch (error: any) {
                setLoading(false);
        ...
        <div className="max-w-sm mx-auto px-4 py-8 ">
            ...
            <form onSubmit={formik.handleSubmit}>
                ...
                <div className="flex justify-between mt-6">
                    <div onClick={() => { }} className=" p-3 bg-gray-600 flex justify-center items-center rounded">
                        <FcPrevious size={20} />
                    </div>
                    <button type="submit" className="btn bg-indigo-600 hover:bg-indigo-600 text-white whitespace-nowrap">{loading ? "sending..." : "Save Password"}</button>
                </div>
            </form>
