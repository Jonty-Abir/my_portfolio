    ...
    const markupArray: markup[] = [
        {
            ...
            about: "This is a real-time chat application. with token base authorization. inspired by @learnWithSumit ❤",
        ...
        },
        {
            ...
            about: "A furniture shop. and implementing JWT authorization with REST-API. ",
        ...
        },
        {
            ...
            title: "Quize App",
            about: "This is a quize application and implementing authentication with FireBase authorization. inspired by @learnWithSumit ❤",
        ...
        <div className="">
            <div className=''>
                <div className=" text-center mt-[6rem]">
                    ...
                    <p className=" text-xl text-indigo-700 font-bold capitalize pt-2">my favorite project</p>
                </div>
            ...
            {/* main parent */}
            <div className="space-y-4 pb-14 flex flex-wrap items-center justify-center gap-x-6 gap-y-4 " id="portfolio">

                {markupArray.map((markUp) => {
                    {/* Card section */ }
                    return (
                        < div key={markUp.id} className="w-[300px] hover:scale-105 duration-300 rounded-md border dark:shadow-gray-400 shadow-gray-800 hover:shadow-none shadow-md bg-slate-50" >
                            {/* Image */}
                            {markUp.image}
                            <div className="p-4" >
                                <h1 className="inline-flex items-center text-lg font-bold text-gray-800">
                                    {/* Heading */}
                                    {markUp.title.toUpperCase()} &nbsp; <ArrowUpRight className="h-4 w-4" />
                                </h1>
                                ...
                                <div className="mt-4">
                                    ...
                                    {markUp.technology.map((v, i) => {
                                        return (
                                            <span key={uniqid()} className={`mb-2 mr-2 inline-block rounded-full  px-3 py-1 text-[10px] font-semibold ${colors[i % markUp.technology.length]}`}>
                                                {v}
                                            </span>
                                        )
                                    })}
                                ...
                                <Link href={markUp.link} target="_blank">
                                    ...
                                    >
                                        <span className='flex justify-center text- items-center gap-x-2'> Get Link <ArrowUpRight className="h-4 w-4" /></span>
                                    </button>
                                </Link>
