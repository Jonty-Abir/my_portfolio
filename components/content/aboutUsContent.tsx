        ...
        <div className=" flex flex-col space-y-20 pt-[6rem] pb-[5rem] px-3 pl-4 md:px-[5rem]">
            ...
            <div className="flex flex-col gap-y-4">
                ...
                <div className="flex flex-col space-y-4">
                    ...
                    <p className="text-gray-400">I have always loved creating things out of scratch. It started with  designing and now it has expanded to web development as well. I love the feeling of creating something out of scratch and have people use it.
                        I also love taking a part of  Open-Source Programs and learning group. I have participated in a few internal-college hackathons as well as the WebSkitter <b>Node JS</b> Development 2023 with a team of seniors and successfully cleared the internal screening. I have successfully Deploy some Project whitch i build.</p>
                    <p className="text-gray-400">Grow consistently and rapidly with the
