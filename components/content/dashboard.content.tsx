...
function DashboardContent() {
    const items = [
        {
            id: uniqId(),
            icone: < GiShoppingCart className=" text-indigo-800" size={32} />,
            category: "E-Commerce",
            about: "Lorem ipsum dolor sit consectetur adipiscing elit sed do.",
            link: "/ecommerce"
        },
        {
            id: uniqId(),
        ...
        <>
            <div className="relative flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-8 lg:py-16 bg-indigo-500 overflow-hidden">
                ...
                <div className="absolute pointer-events-none" aria-hidden="true">
                    <svg width="512" height="512" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle cx="588" cy="650" r="256" transform="translate(-332 -394)" fill="url(#ill-a)" fillRule="evenodd" opacity=".48" />
                    </svg>
                </div>
                {/* Illustration */}
                <div className="absolute pointer-events-none" aria-hidden="true">
                ...
                <div className="relative w-full max-w-2xl mx-auto text-center">
                    ...
                    <form className="relative flex justify-center text-center">
                        ...
                        <input id="action-search" className="form-input pl-9 py-3 text-gray-500 font-semibold focus:border-slate-300 w-full text-lg" placeholder="What are you looking for?" type="search" onChange={() => { }} />
                        <button type="button" className="absolute top-2 left-auto right-1 group" aria-label="Search">
                            {/* <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-search" width="38" height="38" viewBox="0 0 24 24" strokeWidth="2.5" stroke="#597e8d" fill="none" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                ...
                <div className="space-y-8">
                    <div>
                        <div className="mb-5">
                            <h2 className="text-xl text-slate-50 font-bold">Popular Topics</h2>
                        </div>
                        {/* Grid */}
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 lg:sidebar-expanded:grid-cols-2 xl:sidebar-expanded:grid-cols-4 gap-6">
                            ...
                            {items.map((item) => {
                                return (
                                    <div key={item.id} className="bg-indigo-200 text-center rounded-md p-5 dark:shadow-gray-400 shadow-gray-800 hover:shadow-none shadow-md hover:scale-105 duration-300 ">
                                        <div className="flex flex-col h-full">
                                            <div className="grow mb-2">
                                                ...
                                                {/* Content */}
                                                <h3 className="text-lg font-bold text-indigo-800 mb-1">{item.category}</h3>
                                                <div className="text-sm font-semibold text-indigo-500">{item.about}</div>
                                            </div>
                                            {/* Link */}
                                            <div>
                                                <Link className=" text-md font-medium outline-none text-slate-50 border-2 rounded-md bg-indigo-600 hover:bg-indigo-700 py-1 flex items-center justify-center gap-x-2 " href={`${item.link}`}> View <HiChevronDoubleRight /></Link>
                                            </div>
                                        </div>
                                    </div>)
                            })}
