        ...
        <>
                    ...
                    <div className="container relative mx-auto px-4">
                        <div className="-m-8 flex flex-col lg:flex-row">
                            <div className="w-full p-8 lg:w-6/12">
                                <h1 className="lg:text-13xl font-heading mb-9 text-6xl font-bold leading-none md:max-w-2xl md:text-8xl" id='abir'>
                                    Collab With Abir
                                </h1>
                                <div>
                                    ...
                                    <div className="-m-1 flex flex-wrap items-center">
                                        ...
                                        <div className="w-auto p-1">
                                            <div className="-m-0.5 flex flex-wrap">
                                                <div className="w-auto p-0.5">
                                                    <p className="font-bold text-gray-900 dark:text-gray-300">4.0/5</p>
                                                </div>
                                                <div className="w-auto p-0.5">
            ...
            <section className="mx-auto max-w-7xl px-2 py-10 md:px-0">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mx-auto mt-8 max-w-3xl space-y-4 md:mt-16">
                        {/* Propuler question */}
                        {
                            propulerQuestion.map((v) => {
                                return (
                                    <div key={v.id} className="cursor-pointer rounded-md border border-gray-400 shadow-lg transition-all duration-200 dark:border-gray-700 hover:translate-x-2">
                                        <button
                                            type="button"
                                        ...
                                        >
                                            ...
                                            <ChevronUpIcon className="h-5 w-5 text-gray-50" onClick={() => v.setStateFun(!v.state)} />
                                        </button>
                                        <div className={`px-4 pb-5 sm:px-6 sm:pb-6  ${v.state ? " duration-300 block" : "duration-300 hidden"}`}>
                    ...
                    <p className="textbase mt-6 text-center text-gray-600">
                        ...
                        <a href="#abir" title="" className="font-medium text-indigo-600 hover:underline">
                            Contact our support
                        </a>
                    </p>
                </div>
            ...
            <section className="overflow-hidden px-8 py-16 md:px-0">
                <div className="container mx-auto">
                    <h2 id="testimonials" className="my-8 text-left text-3xl font-bold text-black dark:text-white md:text-5xl">
                        Testimonials
                    </h2>
