...
function SingleBlog({ name, isAuthenticate, accessToken, refreshToken, user }: IProps) {
    ...
    return (
        <>
            ...
            <Layout>
                <SingleBlogCompo isAuthenticate={isAuthenticate} accessToken={accessToken} refreshToken={refreshToken} user={user} />
            </Layout>
        </>
    )
}
