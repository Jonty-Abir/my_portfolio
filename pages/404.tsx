    ...
    return (
        ...
        <div className="mx-auto w-full max-w-7xl px-2 md:px-4 mb-6 ">
            <div className="mx-auto my-12 flex max-w-6xl flex-col px-2 md:my-24 lg:my-32 lg:flex-row items-center gap-2">
                <div>
                    <div>
                        <p className="text-sm font-semibold text-black dark:text-gray-300">404 error</p>
                    ...
                    <div className="mt-10 space-y-6">
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-gray-500 dark:text-gray-300">back to the home page.</p>
                        </div>
                        <div>
                            <Link
                                href="/blog"
                            ...
                            <p className="mt-2 text-sm text-gray-500 dark:text-gray-300">Read the latest posts on our blog.</p>
                        </div>
                        <div>
                            <Link
                                href="/dashboard"
                            ...
                            <p className="mt-2 text-sm text-gray-500 dark:text-gray-300">Check our dashboard right here.</p>
                        </div>
                    </div>
                </div>
