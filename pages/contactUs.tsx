import ContactUsContent from "@/components/content/contactUsContent";
...
function ContactUs({ name, user, accessToken, isAuthenticate, refreshToken }: IProps) {
