...
export default function Page({ name }: IProps) {
    ...
    const components = [{ compo: <SendOtp setCount={setState} /> }, { compo: <VerifyOtp setCount={setState} /> }, { compo: <ResetPassword setCount={setState} /> }];
                ...
                <main className=" bg-gray-900 mt-8 pt-2">
                    ...
                    <div className="relative flex">
                        ...
                        <div className=" hidden md:block absolute top-0 bottom-0 right-0 md:w-1/2" aria-hidden="true">
                            ...
                            <Image className="object-cover object-center w-full h-full" src="/assets/img1.jpg" width={760} height={850} alt="Authentication image" />
                            <Image className="absolute top-2/4 -left-8 -translate-x-1/2 ml-8 hidden lg:block" src="/assets/reset-icone.png" width={40} height={40} alt="Authentication decoration" />
                        </div>
